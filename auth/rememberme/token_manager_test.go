...
type testFunc func(rememberme.TokenManager) func(*testing.T)

var managers = make(map[string]rememberme.TokenManager)
...
func TestSuite(t *testing.T) {
	for mName, manager := range managers {
		t.Run(mName, func(t *testing.T) {
			for tName, test := range tests {
				t.Run(tName, test(manager))
			}
		})
	}
}

func testAdd(tm rememberme.TokenManager) func(*testing.T) {
...
func testDelete(tm rememberme.TokenManager) func(*testing.T) {
	return func(t *testing.T) {
		identifier := uuid.NewString()
		token := rememberme.Token{
			Username:   "test_user",
...
func testPurge(tm rememberme.TokenManager) func(*testing.T) {
	return func(t *testing.T) {
		...
		// oldToken2 should now have been purged and validation should fail
...
func testRevoke(tm rememberme.TokenManager) func(*testing.T) {
	return func(t *testing.T) {
		identifier := uuid.NewString()
...
func testValidate(tm rememberme.TokenManager) func(*testing.T) {
	return func(t *testing.T) {
		identifier := uuid.NewString()
